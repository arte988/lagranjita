<?php
$baseUrl = 'http://localhost/formulario.php';
...
if (strcmp($lines[0], "SUCCESS") == 0) {
    ...
    Recibimos $mc_gross Dolares en concepto de: $quantity $item_name.<hr>
    Vuelve a comprar dando clic <a href='http://localhost/Granja/menu.php'>aquí</a>";
    return;
